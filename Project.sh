...
sed 's/ A/ 8/g' < S.txt > S1temp.txt
sed 's/ B+/ 7/g' < S1temp.txt > S.txt
sed 's/ B/ 6/g' < S.txt > S1temp.txt
sed 's/ P/ 5/g' < S1temp.txt > S.txt
sed 's/ C/ 4/g' < S.txt > S1temp.txt
...
do
   ...
   EE110=${arr[8]}
	CS110=${arr[9]}
	i=$(($MA101*4 + $PH100 * 4 + $BE110 * 3 + $BE10105*3 + $BE103*3 + $EE100*3 + $PH110*1 + $EE110*1 + $CS110*1))
...
sed 's/ A/ 8/g' < S1temp.txt > S.txt
sed 's/ B+/ 7/g' < S.txt > S1temp.txt
sed 's/ B/ 6/g' < S1temp.txt > S.txt
sed 's/ P/ 5/g' < S.txt > S1temp.txt
sed 's/ C/ 4/g' < S1temp.txt > S.txt
...
do
    ...
    CS100=${arr[8]}
	CS120=${arr[9]}
	i1=$(($MA102*4 + $CY100 * 4 + $BE100 * 4 + $EC100*3 + $CY110 + $EC110 + $BE102*3 + $CS100*3 + $CS120))
